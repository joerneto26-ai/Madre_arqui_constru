    ...
    <footer className="relative bg-forest-950 text-bone-200">
      <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 sm:py-20">
        <div className="grid gap-12 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
          <div>
            ...
            <p className="mt-5 max-w-xs text-sm leading-relaxed text-bone-200/70">
              Despacho de arquitectura y construcción en San Pedro Garza García.
              Diseño, dirección de obra y proyectos llave en mano con sello de
              calidad.
            </p>
            <div className="mt-6 flex gap-2">
              {socials.map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  aria-label="Red social de ÁUREA"
        ...
        <div className="mt-14 flex flex-col gap-3 border-t border-white/10 pt-8 text-xs text-bone-200/60 sm:flex-row sm:items-center sm:justify-between">
          <p>
            © {year} {brand.name} · Arquitectura y Construcción. Todos los
            derechos reservados.
          </p>
