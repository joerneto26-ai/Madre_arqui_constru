...
const trustMini = [28442318, 25651531, 7752803];
    ...
    <section id="proceso" className="relative bg-bone-50 py-20 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          ...
          title={
            <>
              Arquitectos en Monterrey: tu obra en{" "}
          ...
          lead="De la primera llamada a la entrega llave en mano. Cada etapa con entregables, tiempos y reportes de avance visibles para usted."
        />
        ...
        <div className="mt-12 flex flex-col items-center">
          ...
          <div className="mt-6 flex items-center gap-3">
            ...
            <span className="text-sm text-stone-600">
              <strong className="font-semibold text-ink-900">+140 personas</strong>{" "}
              han confiado su obra a ÁUREA en Monterrey
            </span>
          </div>
        </div>
      </div>
