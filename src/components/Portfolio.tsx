    ...
    >
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          ...
          lead="Una selección de obras en Monterrey. Filtre por tipo para ver proyectos similares al suyo."
        />
            ...
            {visible.map((p, i) => {
              ...
              return (
                <a
                  key={p.title}
                  href={waLink(
                    `Hola ÁUREA, vi el proyecto "${p.title}" en su portafolio y me gustaría algo similar. ¿Me pueden cotizar?`
                  )}
                  target="_blank"
