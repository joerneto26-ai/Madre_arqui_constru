...
const MAPS_EMBED =
  "https://www.google.com/maps?q=Av+Vasconcelos+104+Valle+del+Campestre+San+Pedro+Garza+Garcia&t=&z=15&ie=UTF8&iwloc=&output=embed";

const MAPS_LINK =
  "https://www.google.com/maps/search/?api=1&query=Av+Vasconcelos+104+Valle+del+Campestre+San+Pedro+Garza+Garcia";
...
export function Contact() {
  ...
  function onSubmit(e: FormEvent) {
    ...
    const msg =
      `Hola ÁUREA, soy ${form.nombre} (${form.email}).\n` +
    ...
    <section id="contacto" className="bg-bone-50 py-20 sm:py-28 lg:py-32">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          ...
          lead="Complete el formulario y le respondemos por WhatsApp en menos de 24 horas con una propuesta sin compromiso."
        />
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    placeholder="Ej. Roberto Villarreal"
                    className={inputCls}
                  />
                </div>
          ...
          <Reveal delay={0.12}>
            <div>
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl border border-bone-200/80 shadow-soft">
                <iframe
                  src={MAPS_EMBED}
                  title="Ubicación de ÁUREA en Google Maps"
                  loading="lazy"
        ...
        <div className="text-center">
          <SectionHeading
            ...
            lead="Si su proyecto está en Monterrey o el Área Metropolitana, podemos ayudarle."
          />
          ...
          <Reveal delay={0.16}>
            <p className="mt-6 text-sm text-stone-600">
              ¿No ve su zona?{" "}
              <a
                href={waLink("Hola ÁUREA, quiero saber si atienden en mi zona.")}
                target="_blank"
                rel="noopener noreferrer"
