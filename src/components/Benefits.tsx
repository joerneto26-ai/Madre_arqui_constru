      ...
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-2 lg:gap-16">
        <div>
          ...
          <Reveal delay={0.08}>
            <h2 className="mt-5 font-display text-[1.9rem] leading-[1.1] tracking-tight text-ink-900 sm:text-4xl lg:text-[2.6rem]">
              Una decisión patrimonial, no un gasto.
            </h2>
          </Reveal>
          <Reveal delay={0.16}>
            <p className="mt-5 max-w-xl text-base leading-relaxed text-stone-600 sm:text-lg">
              Cada metro cuadrado que construimos está pensado para proteger y
              multiplicar el valor de su inversión a largo plazo.
            </p>
          </Reveal>
          <Reveal delay={0.24}>
          ...
          <Reveal delay={0.3}>
            <div className="mt-9">
              <Button
                href={waLink(
                  "Hola ÁUREA, me gustaría saber cómo pueden proteger el valor de mi proyecto."
                )}
                target="_blank"
        ...
        <Reveal delay={0.2} className="relative">
          <div className="relative overflow-hidden rounded-3xl shadow-card">
            <img
              src={benefitsImage}
              alt="Interior de residencia con acabados de primer nivel"
              loading="lazy"
